        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          <Stack spacing={4}>
            ...
            <Text color={"gray.500"} fontSize={"lg"}>
              Your Path to Sustainable Living and Convenient Item Exchange
            </Text>
            <Stack spacing={4} divider={<StackDivider borderColor={useColorModeValue("gray.100", "gray.700")} />}>
              <Feature icon={<Icon as={IoAnalyticsSharp} color={"yellow.500"} w={5} h={5} />} iconBg={useColorModeValue("yellow.100", "yellow.900")} text={"Effortless Item Exchange"} />
              <Feature icon={<Icon as={IoLogoBitcoin} color={"green.500"} w={5} h={5} />} iconBg={useColorModeValue("green.100", "green.900")} text={"Easy Donations"} />
              <Feature icon={<Icon as={IoSearchSharp} color={"purple.500"} w={5} h={5} />} iconBg={useColorModeValue("purple.100", "purple.900")} text={" User-Friendly App"} />
            </Stack>
          </Stack>
          <Flex>
